...
repeat with dept in deptlist
	set resp to (do shell script "curl http://localhost:3000/Spit?dept=" & dept)
	
	do shell script "echo " & quoted form of resp & " > /Users/Ben/Dropbox/Developer/KiteandKey/DeptListings/" & dept & ".txt"
	delay 0.5
end repeat
