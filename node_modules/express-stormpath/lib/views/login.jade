  ...
  .container.custom-container
    .va-wrapper
      .view.login-view.container
        .TitleName PennCourseSearch
        .SubtitleName An easier way to search for courses and make schedules
        .box.row
              ...
              .form-group.group-email
                ...
                div(class='#{cls}')
                  ...
                  if app.get('stormpathEnableUsername')
                    ...
                    input.form-control(autofocus='true', placeholder='bfrank@sas.upenn.edu', required=true, name='login', type='text', value=value)
