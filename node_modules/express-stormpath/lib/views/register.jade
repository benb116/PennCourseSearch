  ...
  .container.custom-container
    .va-wrapper
      .view.registration-view.container
        ...
        div.SubtitleName An easier way to search for courses and make schedules
        .box.row
          .col-sm-12
            .header
              span Create Account
            ...
            form.registration-form.form-horizontal.sp-form(method='post', role='form')
              ...
              .form-group.group-email(form-group='true')
                label.col-sm-4 Penn Email
                .col-sm-8
                  - var value = form.data ? form.data.email : '';
                  input.form-control(placeholder='upenn.edu', name='email', value=value, required='true', type='text')
