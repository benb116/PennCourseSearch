...
html(class='no-js', lang='en')
  ...
  head
    ...
    style.
      ...
      .TitleName {font-size: 3em; display: block; clear: both; text-align: center; width:100%; height: 1.5em;}
      .SubtitleName {font-size: 1em; display: block; clear: both; text-align: center; width:100%; height: 2em;}
