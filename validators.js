...
exports.required = function (message) {
    ...
    return function (form, field, callback) {
        if (trim(field.data).length === 0 || trim(field.data).slice(-9) != 'upenn.edu') {
...
exports.isPenn = function (message) {
    ...
    return function (form, field, callback) {
        ...
        var possibleEndings = ['sas.upenn.edu', 'seas.upenn.edu', 'wharton.upenn.edu', 'nursing.upenn.edu', 'upenn.edu']
        if (possibleEndings.indexOf(ending) >= 0) {
            callback();
        } else {
            callback(message);
        }
...
exports.email = function (message) {
    if (!message) { message = 'Please enter a valid upenn.edu address.'; }
