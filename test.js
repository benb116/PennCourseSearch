...
function Filt(obj) {
	return (obj.idDashed.split('-')[0] == 'MEAM');
}
var filtered = allCourses.filter(Filt);
console.log(filtered);

var fi = allCourses.filter(function(obj) {return ((obj.courseReqs.indexOf('ESCI') > -1) && (obj.courseReqs.indexOf('MDP') > -1))});